            ...
            <div id="msform1">
              <form class="row g-3 needs-validation custom-input" id="form" enctype="multipart/form-data">
                ...
                <form1 class="stepper-one row g-3 needs-validation custom-input" >
                     ...
                     <div class="col-sm-12">
                        <label class="form-label" for="email-basic-wizard">Valor Recarregado<span class="txt-danger">*</span></label>
                        <input class="form-control"  type="text" name="saldo"  placeholder="Saldo SMS da Infordata"  >
                      </div>

                </form1>
                <div class="wizard-footer d-flex gap-2 justify-content-end">
                    <button id="botao_salvar" type="submit" class="btn btn-success w-100">
                        <span id="botao_texto">{{__('Registar Saldo da Infordata')}}</span>
...
$(document).ready(function() {
    ...
    $("#form").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('recarregamento.store') }}",
                data: formData,
                ...
                beforeSend: function() {
                    ...
                    $('#botao_texto').text('Registar Saldo Infordata...');
                },
