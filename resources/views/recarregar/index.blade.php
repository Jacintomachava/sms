        ...
        <div class="card-header card-no-border">
            <div class="header-top">
                <h2>
                    ...
                    Recarregar Saldo da Infordata
                </h2>
                <div class="card-header-right-icon">
                    <a href="#">
                        <a class="btn btn-pill btn-primary btn-sm" href="{{route('recarregamento.create')}}" >Registar Saldo Infordata</a>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive custom-scrollbar">
                <table class="display" id="basic-1">
                    ...
                    <tbody>
                        ...
                        @foreach($recarregamentos as $recarregamento)
                            <tr>
                                <td></td>
                                <td>{{$recarregamento->saldo_sms}}</td>
                                <td>{{$recarregamento->saldo_anterior}}</td> 
                                <td>{{\Carbon\Carbon::parse($recarregamento->created_at)->format('d-M-Y') }}</td>
                                <td>
                                    <a class="btn btn-warning btn-xs" href="{{route('recarregamento.edit',['id'=>$recarregamento->id])}}"  >
                                        Editar 
                                    </a>
                                </td>
                            </tr>
